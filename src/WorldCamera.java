...
public class WorldCamera{
    private float xCamera;   // How much the world should shift when the player moves. xCamera = 15 means that the world should shift 15 tiles to the left 
    ...
    public void followPlayer(Player player){
        xCamera = player.getXPos() - display.WIDTH / 2 + player.getWidth() / 2;  // divided by two so the player is on the center of the display
    ...
    public void stopAtCorner(){
        ...
        else if(xCamera > 40 * WorldBlocks.blockWidth - display.getWidth()){  // 40 is the width in the txt folder. Can be automated but to lazy now
